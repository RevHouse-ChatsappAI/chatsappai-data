...
api: 'POST https://dashboard.chatsappai.com/api/datastores/update/{datastoreId}'
...
curl --location --request POST 'https://dashboard.chatsappai.com/api/datastores/update/<datastoreId>' \
