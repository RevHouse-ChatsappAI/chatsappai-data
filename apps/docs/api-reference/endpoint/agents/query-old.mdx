---
title: 'Agent - Query'
api: 'POST https://http://dashboard.chatsappai.com//api/agents/{agentId}/query'
...
curl --location --request POST 'https://http://dashboard.chatsappai.com//api/agents/<agentId>/query' \
