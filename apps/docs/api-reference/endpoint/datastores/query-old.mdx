...
api: 'POST https://dashboard.chatsappai.com/api/datastores/query/{datastore_id}/old'
...
curl --location --request POST 'https://dashboard.chatsappai.com/api/datastores/<datastore_id>/query' \
