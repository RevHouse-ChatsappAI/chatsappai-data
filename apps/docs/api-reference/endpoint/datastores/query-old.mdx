...
api: 'POST https://http://dashboard.chatsappai.com//api/datastores/query/{datastore_id}/old'
...
curl --location --request POST 'https://http://dashboard.chatsappai.com//api/datastores/<datastore_id>/query' \
