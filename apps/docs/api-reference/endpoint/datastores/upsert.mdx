...
api: 'POST https://dashboard.chatsappai.com/api/datastores/upsert/{datastoreId}'
...
curl --location --request POST 'https://dashboard.chatsappai.com/api/datastores/upsert/<datastoreId>' \
