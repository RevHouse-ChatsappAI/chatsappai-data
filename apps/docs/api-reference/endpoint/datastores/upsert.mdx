...
api: 'POST https://http://dashboard.chatsappai.com//api/datastores/upsert/{datastoreId}'
...
curl --location --request POST 'https://http://dashboard.chatsappai.com//api/datastores/upsert/<datastoreId>' \
