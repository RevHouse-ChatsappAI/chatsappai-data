...
api: 'POST https://http://dashboard.chatsappai.com//api/datastores/file-upload/generate-link/{datastoreId}'
...
```js
const apiUrl = 'https://http://dashboard.chatsappai.com//api';
const apiKey = 'XXX';
...
curl --location --request POST 'https://http://dashboard.chatsappai.com//api/datastores/file-upload/generate-link/<datastoreId>' \
