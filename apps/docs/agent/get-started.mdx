...
<Steps>
  <Step title="Create an Agent">
    Go to the [Agents](https://dashboard.chatsappai.com/agents) page. Create a new Agent
    and configure it.
  </Step>
  <Step title="Add Knowledge">
    Create a [Datastore](https://dashboard.chatsappai.com/datastores) and connect it to
