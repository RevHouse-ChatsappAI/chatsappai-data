...
<Steps>
  <Step title="Create an Agent">
    Go to the [Agents](https://http://dashboard.chatsappai.com//agents) page. Create a new Agent
    and configure it.
  </Step>
  <Step title="Add Knowledge">
    Create a [Datastore](https://http://dashboard.chatsappai.com//datastores) and connect it to
